...
import MeterStoreView from "@/views/dashboard/management/meters/store";
...
export default async function MeterManagementPage({ searchParams }: Props) {
  ...
  return (
    <DashboardLayoutWrapper pageTitle="Meter Store">
      <MeterStoreView
        initialData={{
