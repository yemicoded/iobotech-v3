...
import { MeteringTransactions } from "./_components/metering-transactions";
import { BillingTransactions } from "./_components/billing-transactions";
...
export const DashboardTransactionsView: React.FC<Props> = ({ initialData }) => {
    ...
    <Tabs defaultValue="all" className="w-full">
      ...
      <View className="mt-16 mb-6 pt-4 w-full overflow-hidden">
        ...
        <TabsContent value="all" className="">
          <AllTransactions initialData={initialData.allTransactions} />
        </TabsContent>
